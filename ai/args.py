...
parser.add_argument('--noise_dir', default='/Users/triductran/SpartanDev/my-work/multi-speaker-voice-cloning/multi-speaker-voice-cloning-ai/voice-enhancement/data/Train/noise', type=str)

parser.add_argument('--voice_dir', default='/Users/triductran/SpartanDev/my-work/multi-speaker-voice-cloning/multi-speaker-voice-cloning-ai/voice-enhancement/data/Train/clean_voice', type=str)
#folders where to save spectrograms, time series and sounds for training / QC
parser.add_argument('--path_save_spectrogram', default='/Users/triductran/SpartanDev/my-work/multi-speaker-voice-cloning/multi-speaker-voice-cloning-ai/voice-enhancement/data/Train/spectrogram/', type=str)

parser.add_argument('--path_save_time_serie', default='/Users/triductran/SpartanDev/my-work/multi-speaker-voice-cloning/multi-speaker-voice-cloning-ai/voice-enhancement/data/Train/time_serie/', type=str)

parser.add_argument('--path_save_sound', default='/Users/triductran/SpartanDev/my-work/multi-speaker-voice-cloning/multi-speaker-voice-cloning-ai/voice-enhancement/data/Train/sound/', type=str)
...
parser.add_argument('--audio_input_prediction', default=['my-test-2.wav'], type=list)
#File name of sound output of denoise prediction
parser.add_argument('--audio_output_prediction', default='my-test-2-denoise.wav', type=str)
